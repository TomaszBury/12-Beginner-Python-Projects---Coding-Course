...
class TicTacToe:
    ...
    def winner(self, square, letter):
        ...
        # these are the only movews possible to win a diagonal
        if square % 2 == 0:
...
def paly(game, x_player, o_player, print_game=True):
    # returns the winner of the game(letter of winner) or None for a tie.
    if print_game:
    ...
    while game.empty_squares():
        ...
        if game.make_move(square, letter):
            ...
            letter = 'O' if letter == 'X' else 'X'  # <-- swithches player

            # tiny break for humans
            time.sleep(0.8)
...
if __name__ == '__main__':
    ...
    t = TicTacToe()
    paly(t, x_player, o_player, print_game=True)
